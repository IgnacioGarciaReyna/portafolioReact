...
const Programming = () => {
  return (
    ...
    >
      <div className="section-container">
        <div className="section-content">
          <div className="section-header">
            <h2>Me convertí en desarrollador Front End</h2>
            <p>Realicé el Programa Up de Codellege by Softtek</p>
          </div>
          <div className="section-text">
            <p>
              En este curso no solo aprendí desarrollo web, también tuve clases
              de Inglés gramatical y conversacional en las cuales tuve que
              realizar una presentación frente a mis compañeros, tuve un curso
              intensivo de Scrum gracias al que me certifiqué como Scrum
      ...
      <Link to="jobs" spy={true} smooth={true} offset={0} duration={500} className="goto-next"></Link>
    </section>
  );
};
