...
const translations = {
  ...
  en: {
    ...
    about: {
      title: "About me:",
      firstSection: [
        "I also like to spend time playing ",
        "guitar ",
        "and watching ",
        "movies",
        "During the week, I like to play a lot of ",
        "football ",
        "with my friends, and I'm also part of a team that plays a tournament on weekends.",
        "One of my favorite things to do is to go to a coffee shop and have a long black ",
        "coffee",
      ...
      secondSection: [
        "I started studying ",
        "programming ",
        "because I like to solve problems creatively and have always had a knack for technology.",
        "Whether studying at university, taking courses or doing my own projects, programming has always been a lot of ",
        "fun ",
        "for me.",
      ],
      curiosity: {
