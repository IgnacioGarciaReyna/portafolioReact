...
const translations = {
  es: {
    ...
    about: {
      ...
      firstSection: [
        ...
        "Ya sea en la universidad, en cursos o en mis propios proyectos, programar siempre fue muy ",
        "divertido ",
        "para mí.",
      ],
      secondSection: [
        "Durante la semana juego mucho al ",
        "fútbol ",
        "con mis amigos, aunque también me gusta pasar mi tiempo libre tocando la ",
        "guitarra ",
        "y viendo ",
        "películas",
        "Una de mis cosas favoritas es salir a tomar un ",
        "café ",
  ...
  en: {
    ...
    about: {
      ...
      secondSection: [
        "During the week, I play a lot of ",
        "football ",
        "with my friends, but I'm also like to spend my free time playing ",
        "guitar ",
        "and watching ",
        "movies",
